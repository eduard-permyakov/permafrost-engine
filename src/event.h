...
enum eventtype{
    ...
    EVENT_ORDER_ISSUED,
    EVENT_MOVABLE_ENTITY_UNBLOCK,
    EVENT_MOVABLE_ENTITY_BLOCK,
    EVENT_BUILDING_PLACED,
    EVENT_BUILDING_REMOVED,
    EVENT_RALLY_POINT_SET,
    EVENT_UNIT_BECAME_IDLE,
    EVENT_UNIT_BECAME_ACTIVE,
